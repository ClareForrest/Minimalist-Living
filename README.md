...
***Users can post a problem:*** As an apartment enthusiast with a focus on minimalism, I want to be able to describe my problem and find a solution for it, so that I can find an appropriate solution to my problem.

***Users can post a solution:*** As an apartment enthusiast, I want to share my minimalist solutions to everyday living with others, so that they can benefit too. 

***Users can search for a problem:*** As an apartment enthusiast in the CBD, I want to be out enjoying all the city has to offer. I want to be able to look for specific things all in one place, so that I am not trawling through online blogs and forums and store websites to find things to suit my minimalist and functional lifestyle. 
...
***User can comment on solutions and problems:*** As an apartment enthusiast with a focus on minimalism, I have often tried several products and solutions in an attempt to find the best outcome. I want to be able to provide feedback on solutions that I have tried so that I can share my knowledge. I don't want to reinvent the wheel, just add a few spokes here and there. 

***User can receive notifications of solutions:*** As an apartment enthusiast who loves eating parmas and drinking lattes all around the city, I want to be able to receive notification via email of any solutions posted on my problems post so that I don't have to constantly check to see if someone has any ideas for my problem. 
...
## Tech stack
My tech stack is comprised of the below;
- Ruby
- Ruby on Rails
- HTML5
- SCSS
...
Here's a link to my [board](https://trello.com/b/317BULxO/minimalist-apartment-living)
...
Heroku: Having not used this platform before I was not familiar with how it works and when there were deviations from the instructions, this caused some delays in the deployment due to further instructions and help being required. 
...
Stripe: This software program was completely new to me and there are several ways to implement its functionality into an application. A roadblock occured when trying to implement this with the javascript which I'd not studied yet and as the examples weren't an exact match, any deviation from the example required further study and support. 
